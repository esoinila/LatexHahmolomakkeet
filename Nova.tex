...
\begin{minipage}[t]{0.48\textwidth}
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=equipment, width=11.5cm, height=4cm, multiline=true, default={Smartphone  LED Bodysuit  Portable Ring Light  Designer Sunglasses  Tripod  Neon Accessories  Camera Drone  Makeup Kit  mushrooms  smoke grenades}, backgroundcolor=boxcontentbg, borderwidth=0, bordercolor=boxcontentbg]{}
    \end{tcolorbox}
\end{minipage}
