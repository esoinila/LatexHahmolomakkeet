...
\begin{tcolorbox}[
  ...
  \begin{minipage}[c]{0.28\textwidth}
    \centering
    \includegraphics[width=\linewidth, height=6cm, keepaspectratio]{images/varn_picture.jpg}
  \end{minipage}%
  \hfill
  \begin{minipage}[c]{0.68\textwidth}
    ...
    \begin{tcolorbox}[colback=namebg, boxrule=0pt, arc=2pt, width=\textwidth, left=0pt, right=0pt, top=2mm, bottom=2mm]
      {\fontsize{38}{44}\selectfont Dr Varn}
    \end{tcolorbox}
    \vspace{0.7cm}
    {\large\itshape "Atlantis called. They want their secrets back!"}
  \end{minipage}
\end{tcolorbox}
\end{center}
