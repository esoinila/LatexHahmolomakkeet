...
\begin{minipage}[t]{0.48\textwidth}
    ...
    \begin{tcolorbox}[
        ...
        \begin{minipage}[c][3.3cm][c]{0.75\linewidth}
            \centering
            \TextField[name=character_name, width=9cm, height=1cm, multiline=true, default={Dr Varn}]{}
        \end{minipage}
    \end{tcolorbox}
...
Cryptography
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=background, width=11.5cm, height=4.5cm, multiline=true, default={
