...
\begin{minipage}[t]{0.48\textwidth}
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=abilities, width=11.5cm, height=2cm, multiline=true, default={
...
\begin{minipage}[t]{0.48\textwidth}
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=personality, width=11.5cm, height=2cm, multiline=true, default={
Adventurous \newline
Analytical \newline
Charismatic \newline
Cautious \newline
...
Skeptical
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=handicaps, width=11.5cm, height=2cm, multiline=true, default={
...
Overconfidence
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=equipment, width=11.5cm, height=3.2cm, multiline=true, default={
