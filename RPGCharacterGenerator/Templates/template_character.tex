...
\begin{minipage}[t]{0.48\textwidth}
    ...
    \begin{tcolorbox}[
        ...
        \begin{minipage}[t][4cm]{0.22\linewidth}
            \centering
            \includegraphics[width=0.9\linewidth, height=3.8cm, keepaspectratio=true]{images/[[IMAGE]]}
            \vspace{0pt}
        \end{minipage}%
        \hspace{0.2cm}%
        \begin{minipage}[t][4cm]{0.74\linewidth}
            \centering
            \TextField[name=character_name, width=8cm, height=2cm, multiline=true, default={[[NAME_AND_HANDLE]]}, charsize=20pt, backgroundcolor=boxcontentbg, borderwidth=0, bordercolor=boxcontentbg]{}
        \end{minipage}
    \end{tcolorbox}
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=background, width=11.5cm, height=5.5cm, multiline=true, default={[[BACKGROUND]]}, backgroundcolor=boxcontentbg, borderwidth=0, bordercolor=boxcontentbg]{}
    \end{tcolorbox}
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=abilities, width=11.5cm, height=3cm, multiline=true, default={[[ABILITIES]]}, backgroundcolor=boxcontentbg, borderwidth=0, bordercolor=boxcontentbg]{}
    \end{tcolorbox}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\textwidth}
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=personality, width=11.5cm, height=2.5cm, multiline=true, default={[[PERSONALITY]]}, backgroundcolor=boxcontentbg, borderwidth=0, bordercolor=boxcontentbg]{}
    \end{tcolorbox}
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=handicaps, width=11.5cm, height=2.5cm, multiline=true, default={[[STRESS_RESPONSE]]}, backgroundcolor=boxcontentbg, borderwidth=0, bordercolor=boxcontentbg]{}
    \end{tcolorbox}
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=equipment, width=11.5cm, height=4cm, multiline=true, default={[[EQUIPMENT]]}, backgroundcolor=boxcontentbg, borderwidth=0, bordercolor=boxcontentbg]{}
    \end{tcolorbox}
\end{minipage}
