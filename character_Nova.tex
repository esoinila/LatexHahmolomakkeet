...
\begin{minipage}[t]{0.48\textwidth}
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=handicaps, width=11.5cm, height=2.5cm, multiline=true, default={Method Acting Madness \quad Delusions of Divinity \quad Prophetic Hysteria \newline The Skeptic's Shadow}, backgroundcolor=boxcontentbg, borderwidth=0, bordercolor=boxcontentbg]{}
    \end{tcolorbox}
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=equipment, width=11.5cm, height=4cm, multiline=true, default={Smartphone  LED Bodysuit  Portable Ring Light  Designer Sunglasses  Tripod  Neon Accessories  Camera Drone  Makeup Kit  Mushrooms  Smoke Grenades  Derringer \quad High-Powered Flashlight \quad Blessed Scarab \quad Ancient Map Fragment \quad Voice Mimicry Device}, backgroundcolor=boxcontentbg, borderwidth=0, bordercolor=boxcontentbg]{}
    \end{tcolorbox}
\end{minipage}
