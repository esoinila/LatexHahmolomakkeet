...
\begin{minipage}[t]{0.48\textwidth}
    ...
    \begin{tcolorbox}[
        ...
        \begin{minipage}[t][4cm]{0.22\linewidth}
            \centering
            \includegraphics[width=0.9\linewidth, height=3.8cm, keepaspectratio=true]{images/Saphire.jpg}
            \vspace{0pt}
        \end{minipage}%
        \hspace{0.2cm}%
...
\begin{minipage}[t]{0.48\textwidth}
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=personality, width=11.5cm, height=2.5cm, multiline=true, default={Charismatic Performer \quad Eccentric Visionary \quad Strategic Manipulator \newline Resilient Optimist \quad Family Loyalist \quad Adaptable Chameleon}, backgroundcolor=boxcontentbg, borderwidth=0, bordercolor=boxcontentbg]{}
    \end{tcolorbox}
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=handicaps, width=11.5cm, height=2.5cm, multiline=true, default={Persona Inversion (clueless act cracks) \quad Device Paranoia (distrusts electronics) \newline Reckless Vindication (takes extreme risks) \quad Auditory Scorn (hears mocking voices)}, backgroundcolor=boxcontentbg, borderwidth=0, bordercolor=boxcontentbg]{}
    \end{tcolorbox}
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=equipment, width=11.5cm, height=4cm, multiline=true, default={Mushrooms \quad Smoke Grenades \quad Derringer \quad Blessed Scarab \newline Ancient Coin \quad Strange Idol \quad Eagle Faction Communicator}, backgroundcolor=boxcontentbg, borderwidth=0, bordercolor=boxcontentbg]{}
    \end{tcolorbox}
\end{minipage}
