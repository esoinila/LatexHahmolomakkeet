...
\begin{minipage}[t]{0.48\textwidth}
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=equipment, width=11.5cm, height=4cm, multiline=true, default={Glowing Scroll  Atlantean Compass  Crystal Pendant  Field Satchel  Voice Recorder  Pith Helmet  Leather Journal  Mystic Monocle  Mushrooms  Smoke Grenades  Snubnose Revolver}, backgroundcolor=boxcontentbg, borderwidth=0, bordercolor=boxcontentbg]{}
    \end{tcolorbox}
\end{minipage}
