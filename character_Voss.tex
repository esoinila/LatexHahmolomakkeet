...
\begin{minipage}[t]{0.48\textwidth}
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=background, width=11.5cm, height=5.5cm, multiline=true, default={Dr. Alaric Voss, once a tenured archaeology professor at Cambridge, was forced into early retirement for pushing controversial theories about Atlantis and the true purpose of megalithic structures. With 1.5M followers on YouTube (@TheOracleOfStone), he's become a leading figure in alternative archaeology. His channel features detailed analyses of ancient sites and passionate exposés of historical cover-ups. Now a globe-trotting independent researcher, he documents forbidden knowledge and ancient technology with obsessive fervor. His passion lies in decoding lost civilizations and exposing historical cover-ups. Alaric is often seen clutching his glowing parchment and muttering about energy grids and sacred geometry. His loyal followers call him The Oracle of Stone. Never without his high-end smartphone, professional 4K camera setup, and portable studio lighting, he maintains a constant connection with his audience while exploring ancient sites.}, backgroundcolor=boxcontentbg, borderwidth=0, bordercolor=boxcontentbg]{}
    \end{tcolorbox}
