...
\begin{minipage}[t]{0.48\textwidth}
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=abilities, width=11.5cm, height=3cm, multiline=true, default={\newlinechar Ancient Tech \qquad \hspace{10mm} Social Media \newline \qquad \newline Pyramid Explorer \qquad Electrical Eng Persuasion Stealth Yoga & Meditation}, backgroundcolor=boxcontentbg, borderwidth=0, bordercolor=boxcontentbg]{}
    \end{tcolorbox}
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=background, width=11.5cm, height=5.5cm, multiline=true, default={Ancient tech expert, social media influencer. Born in Egypt, Varn has studied the pyramids his whole life. Lately, vivid dreams of Atlantis plague his sleep, filled with whispers from Thoth urging him to seek hidden knowledge. He suspects a secretive order watches his progress. Varn uses his influencer status to fund expeditions, gathering both artifacts and unwitting participants for purposes only he truly understands.}, backgroundcolor=boxcontentbg, borderwidth=0, bordercolor=boxcontentbg]{}
    \end{tcolorbox}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\textwidth}
