...
\begin{minipage}[t]{0.48\textwidth}
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=background, width=11.5cm, height=5.5cm, multiline=true, default={Sapphire Skye Monroe is a globe-trotting "Spiritual CEO" who rose to fame after going viral for misreading Egyptian hieroglyphs on TikTok. Born in L.A. but claiming she's "from Atlantis," she quit her juice bar job to promote luxury crystal water bottles and sand-based skincare. Known for mixing edgy and ancient styles---leather jackets over toga pants---she gives chaotic "enlightenment tours" at ruins while plugging overpriced wellness products. Clueless but confident, she's the ultimate parody influencer in your RPG world.}, backgroundcolor=boxcontentbg, borderwidth=0, bordercolor=boxcontentbg]{}
    \end{tcolorbox}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\textwidth}
    ...
    \begin{tcolorbox}[
        ...
        \TextField[name=equipment, width=11.5cm, height=4cm, multiline=true, default={Smartphone  Crystal Water Bottle  Selfie Stick  Designer Sunglasses  mushrooms  smoke grenades}, backgroundcolor=boxcontentbg, borderwidth=0, bordercolor=boxcontentbg]{}
    \end{tcolorbox}
\end{minipage}
